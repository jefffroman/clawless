...
# Replaces the Lightsail module for clients marked provider=fargate. Single
# task per client; desired_count flipped 0↔1 for sleep/wake by the lifecycle
# Lambda. No scaling policies — each client is one task.
